...
namespace JTRP.ShaderDrawer
{
    ...
    public class MainDrawer : MaterialPropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, MaterialProperty prop, string label, MaterialEditor editor)
        {
            ...
            bool result = Func.Foldout(ref show, value, style == 0 || style == 1, label);
    ...
    public class SubDrawer : MaterialPropertyDrawer
    {
        ...
        {
            get{ return Func.NeedShow(group);}
        }
        //protected virtual bool matchPropType => true;
        protected virtual bool matchPropType
        {
            get {return true;}
        }
        ...
        //public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        public override void OnGUI(Rect position, MaterialProperty prop, string label0, MaterialEditor editor)
        {
            GUIContent label = new GUIContent(label0);
            ...
            if (group != "" && group != "_")
            {
                ...
                if (needShow)
                {
                    ...
                    else
                    {
                        ...
                        editor.DefaultShaderProperty(prop, label0);
                    }
                }
                EditorGUI.indentLevel--;
            }
    ...
    public class KWEnumDrawer : SubDrawer
    {
        ...
        protected override bool matchPropType
        {
            get{ return prop.type == MaterialProperty.PropType.Float;}
        }
    ...
    public class TexDrawer : SubDrawer
    {
        ...
        protected override bool matchPropType
        {
            get{return prop.type == MaterialProperty.PropType.Texture;}
        }
    ...
    public class ColorDrawer : SubDrawer
    {
        ...
        protected override bool matchPropType
        {
            get {return prop.type == MaterialProperty.PropType.Color;}
        }
        //bool isHSV => parameter.Contains("HSV");
        bool isHSV
        {
            get{return parameter.Contains("HSV");}
        }
        bool lastHSV;
        string parameter;
        ...
        public override void DrawProp(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        {
            ...
            for (int i = 1; i < count; i++)
            {
                ...
                dst = EditorGUI.ColorField(r, GUIContent.none, src, true, true, hdr, null);
                if (EditorGUI.EndChangeCheck())
                {
                    if (isHSV)
    ...
    public class SubPowerSliderDrawer : SubDrawer
    {
        ...
        protected override bool matchPropType
        {
            get { return prop.type == MaterialProperty.PropType.Range; }
        }
        float power;
    ...
    public class QueueDrawer : MaterialPropertyDrawer
    {
        ...
        {
            EditorGUI.BeginChangeCheck();
            editor.FloatProperty(prop, label);
