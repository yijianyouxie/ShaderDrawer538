...
//{
//    internal class HDStandardParticlesGUI : ShaderGUI
//    {
...
//            public static GUIContent normalMapText = EditorGUIUtility.TrTextContent("Distortion Map", "Distortion Map.");
...
//            zOffset = FindProperty("_ZOffset", props);
...
//            bumpMap = FindProperty("_DistortionMap", props);
...
//                m_MaterialEditor.ShaderProperty(zOffset, "Z Offset");
...
//            bool useTangents = useLighting && material.GetTexture("_DistortionMap");

//            bool useGPUInstancing = material.enableInstancing;
...
//            SetKeyword(material, "_NORMALMAP", (useLighting || useDistortion) && material.GetTexture("_DistortionMap"));
